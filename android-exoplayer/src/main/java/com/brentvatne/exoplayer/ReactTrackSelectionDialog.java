...
public final class ReactTrackSelectionDialog extends DialogFragment {
     ...
     *     dismissed.
     */
    public static ReactTrackSelectionDialog createForTrackSelector(
            DefaultTrackSelector trackSelector, DialogInterface.OnDismissListener onDismissListener) {
        MappedTrackInfo mappedTrackInfo =
                Assertions.checkNotNull(trackSelector.getCurrentMappedTrackInfo());
        ReactTrackSelectionDialog trackSelectionDialog = new ReactTrackSelectionDialog();
     ...
     *     dismissed.
     */
    public static ReactTrackSelectionDialog createForMappedTrackInfoAndParameters(
            int titleId,
            MappedTrackInfo mappedTrackInfo,
    ...
    public ReactTrackSelectionDialog() {
